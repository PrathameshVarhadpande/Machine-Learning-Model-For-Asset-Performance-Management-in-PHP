...
$dataset=Labeled::fromIterator(new CSV('heat_reliability.csv'));
...
$estimator = new KNearestNeighbors(3, true, new Hamming(10));
...
$output = array_slice($predictions, 1, 3);

// Printing the predicted value

echo '<br>Reliability Status of the Machine : ' . ($output[1]);
